---
read_when: Import source snapshots, change consolidation structure, or assess consolidation acceptance.
---
...
This document preserves the consolidation specification and its acceptance requirements.
Use the root AGENTS.md for routine repository policy.
Resolve paths and commands in this document from the repository root, unless a section states otherwise.
...
Read the relevant sections for consolidation, provenance, or exact-source acceptance work.
...
The root AGENTS.md governs repository policy. This specification supplies additional requirements for consolidation tasks.
